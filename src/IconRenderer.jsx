  ...
  return (
    ...
    >
      <defs>
        ...
        <rect id="vs-code-b" width="690" height="840" x="171.142" y="84.824" rx="22" />
        <filter
          id="vs-code-a"
          width="106.1%"
          height="105%"
        ...
        />
        <linearGradient id="vs-code-f" x1="5.234%" x2="50%" y1="3.683%" y2="50%">
        ...
        <polygon id="vs-code-i" points="259.369 737.918 821.277 830.453 987.705 727.844" />
      </defs>
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="#E0E0E0" style={{ mixBlendMode: 'multiply' }} xlinkHref="#vs-code-d" />
